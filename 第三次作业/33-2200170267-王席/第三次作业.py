...
# 从CSV文件加载数据
data = pd.read_csv('C:\\Users\\14774\\Documents\\output.csv', header=None)
...
plt.ylabel('Loss')
plt.title('Training and Validation Loss Over Iterations,对数据进行了归一化，alpha=0.003',color='red')  # 添加标题
plt.legend()
