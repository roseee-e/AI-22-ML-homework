...
path = 'C:\\Users\\86178\\Documents\\Tencent Files\\3061593833\\FileRecv\\ex2data1.txt'
...
plt.figure()
w = 1
plt.plot(fpr_all, mean_tpr, color='darkorange', lw=w, label='ROC curve (area = %0.2f)' % roc_auc)
plt.plot([0, 1], [0, 1], color='navy', lw=w, linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
