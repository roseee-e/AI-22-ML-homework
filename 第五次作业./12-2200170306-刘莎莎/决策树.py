# -*- coding: utf-8 -*-
"""
Created on Sat May 18 20:39:11 2024
...
Data = [['青年','否','否','一般','否'],['青年','否','否','好','否'],['青年','是','否','好','是'],
        ['青年','是','是','一般','是'],['青年','否','否','一般','否'],['中年','否','否','一般','否'],
        ['中年','否','否','好','否'],['中年','是','是','好','是'],['中年','否','是','非常好','是'],
        ['中年','否','是','非常好','是'],['老年','否','是','非常好','是'],['老年','否','是','好','是'],
        ['老年','是','否','好','是'],['老年','是','否','非常好','是'],['老年','否','否','一般','否']]


data = pd.DataFrame(Data,columns=['年龄','有工作','有房子','信用','类别'])
y_train = data.shape[1]



## 把特征属性专成数字
# path ='/Users/lihuiwang/Desktop/王丽会教学/王丽会-机器学习-课件/code/watermelon2.0.txt'
# path ='/Users/lihuiwang/Desktop/王丽会教学/王丽会-机器学习-课件/code/watermelon_3.csv'
...
# df['信用'] = df['信用'].map({'一般':1,'好':2,'老非常好':3})
# df['类别'] = df['类别'].map({'是':1,'否':2,})
