...
# 加载数据
file_path = 'C:/Users/小黑/Desktop/机器学习/第五/26_2200170246_莫永清/Data.txt'
...
# 计算每个属性的信息增益
attributes = df.columns[:-1]  # 排除最后一列（目标）
information_gain = {attribute: calculate_information_gain(df, attribute, total_entropy) for attribute in attributes}
...
dot.format = 'png'
dot.render('C:/Users/小黑/Desktop/机器学习/第五/26_2200170246_莫永清/decision_tree')
